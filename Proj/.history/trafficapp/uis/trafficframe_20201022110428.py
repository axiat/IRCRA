...
class WTrafficDialog(QDialog):
    def __init__(self):
        ...
        self.ui.lbl_video_2.clicked.connect(self.switch_video1_main)
        self.ui.lbl_video_3.clicked.connect(self.switch_video1_main)
        self.ui.lbl_video_4.clicked.connect(self.switch_video1_main)
        self.ui.lbl_video_5.clicked.connect(self.switch_video1_main)
        self.ui.lbl_video_6.clicked.connect(self.switch_video1_main)
        self.ui.lbl_video_7.clicked.connect(self.switch_video1_main)
