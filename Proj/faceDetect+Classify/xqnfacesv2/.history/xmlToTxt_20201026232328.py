...
dirpath='/home/qin/SeniorA/PracticeA/IRCRA/Proj/faceDetect+Classify/xqnfacesv2/Annotations'
newdir='/home/qin/SeniorA/PracticeA/IRCRA/Proj/faceDetect+Classify/xqnfacesv2/AnnotationsTxt'
    ...
    # for child in root.findall('item'):  # 找到图片中的所有框
        ...
        try:  # 转换成yolov3的标签格式，需要归一化到（0-1）的范围内
            ...
            if sub_label.text == 'XuQinning':
                f.write(' '.join(['4', str(x_center), str(y_center), str(w), str(h) + '\n']))
